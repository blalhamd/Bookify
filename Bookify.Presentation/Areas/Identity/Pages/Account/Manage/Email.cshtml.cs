...
namespace Bookify.Presentation.Areas.Identity.Pages.Account.Manage
{
    public class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
				...
				var body = await _emailBodyBuilder.GenerateEmailBody("emailTemplate.html", imageFromGoogle, $"Hi {user.FirstName}",
